<?php
$file = '/mnt/Share/Menu_Update/Apps_Setup/php/iTunes_start';
$newfile = '/mnt/dms';
...
<P><FONT class=style9>Starting iTunes Server</FONT></P>
<br>
<table width="550" border="0" cellpadding="0" cellspacing="0">
<tr> 
<td width="100%" bgcolor="#FFFFFF">
<font size=3>&nbsp;&nbsp;iTumes Server (mt-daapd) will start in 20 seconds.<br>&nbsp;&nbsp;Please wait up to be redirected.</font></td></tr>
