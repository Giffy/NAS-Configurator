...
<P><FONT class=style9>Starting MLDonkey</FONT></P>
<br>
<table width="550" border="0" cellpadding="0" cellspacing="0">
<tr> 
<td width="100%" bgcolor="#FFFFFF">
<font size=3>&nbsp;&nbsp;MLDonkey will start in 20 seconds.<br>&nbsp;&nbsp;Please wait up to be redirected.</font></td></tr>
...
settime();
function settime(){setTimeout("reloadurl()",0);
return true;}
function reloadurl()
